...
const SpecialOffer = () => {
  return (
    ...
    justify-wrap items-center max-xl:flex-col-reverse
    gap-10 max-container">
    <div className="flex-1">
      <img src={offer} alt="" width={273}
      height={487} className="object-contain
      w-full"/>
      </div>
      ...
      capitalize font-bold lg:mx-w-lg">
      <span className="text-coral-red"> Special 
      </span> Offer
      </h2>
      
      <p className="mt-4 lg:max-w-lg info-text">Embark 
      on a shopping journey that redefines your 
      experience with unbeatable deals. From premium 
      ...
      fulfil your unique desires, surpassing the left 
